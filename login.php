...
<form action="verify.php" method="post" id="div-height" class="form">
    ...
    ?>
    <h3 align=center>Login to Stream Music</h3>
    ...
    <p style="font-size: 12px; text-align:center"><a href="register.php"> Join Fyvee Membership </a> or go to <a href="index.php"> <i class='fa fa-home'></i> </a> instead.</p>
</form>